  ...
  var Plugin = (() => {
    ...
    var User = ({ name, username, email, address }) => {
      return /* @__PURE__ */ h(
        "div",
        { className: "user-item" },
        /* @__PURE__ */ h("h2", { className: "text-xl font-semibold" }, name),
        /* @__PURE__ */ h(
          "p",
    ...
    var Caputo = async () => {
      ...
      return /* @__PURE__ */ h(
        ...
        /* @__PURE__ */ h("h2", { style: { color: "green" } }, "Caputo"),
        Object.keys(data).length > 0
          ...
          : /* @__PURE__ */ h(
              ...
              /* @__PURE__ */ h("p", null, "No data available")
            )
      );
    };
      ...
      try {
        try {
          ...
          return /* @__PURE__ */ h(
            ...
            /* @__PURE__ */ h("p", null, "Server error: ", e.message)
          );
        }
      } catch (e) {
